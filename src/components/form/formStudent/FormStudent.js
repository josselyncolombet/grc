                ...
                <div className="form-student">
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="date" className="form-control form-control-sm" id="birthdate" name="birthdate" placeholder="Date de naissance" onChange={(e) => this.handleInputChange(e)} />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <select name="cursus" className='custom-select' value={this.state.cursus} onChange={(e) => this.handleInputChange(e)}>
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <select name="source" className='custom-select' value={this.state.source} onChange={(e) => this.handleInputChange(e)}>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <select name="institute" className='custom-select' value={this.state.institute} onChange={(e) => this.handleInputChange(e)}>
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <select name="driverLicence" className='custom-select' value={this.state.driverLicence} onChange={(e) => this.handleInputChange(e)}>
